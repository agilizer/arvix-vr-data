var FormsSelect = {
	...
	selectizeCustomization: function () {
		$('.selectize-customization').selectize({
			...
			searchField: 'name',
			options: [
				{id: 1, name: 'Tolga Ergin', email: 'tolgaergin@gmail.com', photo: '../../assets/globals/img/faces/1.jpg'},
				{id: 2, name: 'Gökhun Güneyhan', email: 'gokhun@mail.org', photo: '../../assets/globals/img/faces/2.jpg'},
				{id: 3, name: 'Michelle Myers', email: 'mymichelle@mymichelle.org', photo: '../../assets/globals/img/faces/3.jpg'},
			],
			render: {
