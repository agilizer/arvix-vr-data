window.MP_PREFETCHED_MODELDATA = {
	"files" : {
		...
		"templates" : [
				...
				"https://mp-app-prod.global.ssl.fastly.net?path={{filename}}&root=models/group_1258/job_400c3158-26b8-461b-8c37-ddd2b322a7c4/wf_5465b36db14041d191d36bd4f0719843/mesh/1.1.407.13667/2016-09-09_2039.56&sig=652ebd4639f7dc48c389650e072c25413e3c9066&exp=1474969897" ],
		"type" : "3"
	},
	"keys" : {
	...
	"user" : {
		"flags" : [ "panospheres", "floorplan", "billing_tab_hidden",
					"tag_links", "fastly_v2_urls", "workshop_webgl",
					"show360views", "showcase_gzip_100", "showcase_preheat_100",
					"showcase_vr", "mattertags", "list_signed_urls_default_3",
					"model_settings" ],
